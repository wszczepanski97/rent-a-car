...
import {
  ActionEventArgs, Agenda, Day, DragAndDrop, EventRenderedArgs, ExcelExport, Inject, Month, PopupCloseEventArgs, Print, Resize, ScheduleComponent, Week,
  WorkWeek
      ...
      <>
        ...
        <ScheduleComponent
          ...
          editorTemplate={useCallback(
            ...
            [additionalRentOptions, cars, clients, employees, insurances, locations, services]
          )}
