...
import ServicesGrid from "templates/mechanic/dashboard/components/servicesgrid/servicesgrid.component";
...
const DashboardPage: NextPageWithLayout<DashboardPageProps> = ({
  ...
  return (
    <SWRConfig value={{ refreshInterval: 180000 }}>
      <Head>
        <title>Panel główny - mechanik</title>
      </Head>
