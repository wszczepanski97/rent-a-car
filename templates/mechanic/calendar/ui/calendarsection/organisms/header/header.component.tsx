  ...
  const onExportClick = () => {
    schedule?.exportToExcel({
      fieldsInfo: [
        ...
        { name: "AutoryzowanySerwis", text: "Autoryzowany serwis" },
        { name: "SamodzielnaNaprawa", text: "Samodzielna naprawa" },
        { name: "Warsztat", text: "Warsztat" },
      ],
      ...
      fileName: `Wykaz Mechanik ${new Date().toLocaleDateString()}`,
    });
  };
  return (
