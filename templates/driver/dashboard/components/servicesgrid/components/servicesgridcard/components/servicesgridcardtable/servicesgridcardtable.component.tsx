...
import { useDrive } from "templates/driver/dashboard/swr/useDrive.swr";
import { Service } from "templates/driver/dashboard/types";
...
const ServicesGridCardTable: FC<ServicesGridCardTableProps> = ({
  ...
  const { data: serviceData, isError, isLoading, mutate } = useDrive();
  const columns = useMemo<Column<Service>[]>(
    () => [
      { Header: "Nr relokacji", accessor: `IdRelokacje` },
