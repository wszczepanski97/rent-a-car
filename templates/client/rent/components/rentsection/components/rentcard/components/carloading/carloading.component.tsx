  ...
  return (
    <div className={styles.container}>
      ...
      >
        ...
        <g className={classnames(styles.wheel, styles["back-wheel"])}>
          <circle cx="18" cy="56" r="6.75" />
          <circle
            className={styles["wheel-details"]}
            cx="18."
            cy="56"
            r="3.12"
          />
        ...
        <g className={classnames(styles.wheel, styles["front-wheel"])}>
        ...
        />
        <line
          className={classnames(styles.line, styles["line-floor"])}
          x1="76.5"
          y1="62.43"
          x2="3.5"
          y2="62.43"
